...
<div class="container">
  <h3>Add a Seller</h3> <br />
  <form class="form-horizontal" action="seller_added.php" method="post">
    <div class="form-group">
      <label class="control-label col-sm-2" for="sellername">Seller Name:</label>
      <div class="col-sm-3">
        <input type="text" class="form-control" id="sellername" placeholder="Enter Seller Name" name="sellername">
      </div>
    </div>
    <div class="form-group">
