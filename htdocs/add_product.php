...
<div class="container">
  ...
  <form class="form-horizontal" action="product_added.php" method="post">
...
?>
 ...
 <div class="form-group">
      ...
      <div class="col-sm-3">
        <input type="text" class="form-control" id="productprice" placeholder="Enter Price" name="productprice">
      </div>
    </div>
 </div>
    <div class="form-group">        
