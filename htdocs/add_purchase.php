...
<div class="container">
  <h3>Add Purchase from a Seller</h3> <br />
  <form class="form-horizontal" action="purchase_added.php" method="post">
...
?>
    ...
    <div class="form-group">
      ...
      <div class="col-sm-3">          
        <input type="text" class="form-control" id="purchasedate" placeholder="Enter date" name="purchasedate"> 
      </div>
      <label> (yyyy-mm-dd) </label>
    </div>
    <div class="form-group">
      <label class="control-label col-sm-2" for="amount">Purchase Amount:</label>
      <div class="col-sm-3">          
        <input type="text" class="form-control" id="amount" placeholder="Enter Purchase Amount" name="amount">
      </div>
    </div>
    <div class="form-group">        
